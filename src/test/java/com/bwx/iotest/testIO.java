...
//        BufferedReader in = new BufferedReader(new FileReader("d:\\test\\test.txt"));
    ...
    public void testio2() throws IOException {
        ...
        String string = "";
        BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream("C:\\Users\\admin\\Desktop\\aa.txt"), "UTF-8"));
...
//            writeFile("E:\\Test\\test1111\\test" + i + ".htm", aaa.toString());
//        }
...
//            for (int i2 =1;i2<10;i++)
            writeFile2( "D:\\Test\\test12\\aa"+i+".txt", aa);
    ...
    @Test
    public void testFileauth() throws IOException {
        File file = new File("D:\\Test\\test12\\test1.txt");
        //如果没有文件就创建
        file.exists();
