...
public class MultiReadTest {
    ...
    public static void main(String[] args) {
        ...
        final int DOWN_THREAD_NUM = 8;//起10个线程去读取指定文件
        final String OUT_FILE_NAME = "D:\\Test\\test.txt";
        final String keywords = "b";
...
//      }
        ...
        System.out.println("指定关键字出现的次数：" + ReadThread.atomicInteger);
    }
}
