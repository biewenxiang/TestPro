 ...
 * 线上业务监听
 */
public class KafkaConsumerIndex24 {

    private static Logger logger = LoggerFactory.getLogger(KafkaConsumerIndex24.class);
...
//        props.put("bootstrap.servers", Constant.kafka_host);
        ...
        props.put("group.id", "test20191219");
...
//        props.put("auto.offset.reset", "earliest");
        ...
        consumer.subscribe(Arrays.asList("index_24h_domestic_storm"));
