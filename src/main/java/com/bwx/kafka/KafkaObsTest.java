 ...
 * 测试环境
 */
public class KafkaObsTest {

    static String kafkahost = Constant.kafka_host;
    private static Logger logger = LoggerFactory.getLogger(KafkaObsTest.class);
...
//        props.put("auto.offset.reset", "latest");
        ...
        consumer.subscribe(Arrays.asList("obs_yesterday"
                , "obs_today"
        ));
    }
