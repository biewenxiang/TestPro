 ...
 * 线上业务监听
 */
public class KafkaConsumer12HTest2 {

    private static Logger logger = LoggerFactory.getLogger(KafkaConsumer12HTest2.class);
...
//        props.put("auto.offset.reset", "earliest");
        ...
        consumer.subscribe(Arrays.asList("ocf_12h_tourism",
                ...
                "baidu_overseas",
                "the_command",
                "index_24h_domestic","obs_yesterday","obs_today",
                "ocf_12h_ski"));
